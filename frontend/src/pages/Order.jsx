...
import { Plus, Minus, Trash2, ArrowRight, MessageCircle, ShoppingBag } from "lucide-react";
...
const Order = () => {
  ...
  const sendWhatsApp = () => {
    ...
    if (!form.customer_name || !form.phone || !form.address) {
      return toast.error("Please fill name, phone and address first.");
    }
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="text-center mb-14 relative">
          ...
          <p className="font-body text-white/65 mt-4 max-w-xl mx-auto">
            Cash on delivery within Samundri. We'll call you to confirm.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-10">
            ...
            {items.length === 0 ? (
              ...
              <div className="space-y-3">
                {items.map((it) => (
                  <div
                    key={it.id}
                    data-testid={`order-cart-row-${it.id}`}
          ...
          >
            <h2 className="font-heading text-4xl text-white">Delivery Details</h2>
            <div>
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              >
                {submitting ? "Placing…" : (<><ArrowRight size={16} /> Place Order</>)}
              </button>
              <button
                type="button"
